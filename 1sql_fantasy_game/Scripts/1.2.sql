...
--(По результату запроса) 1,307,678 покупок совершено на сумму 686,615,040 райских лепестков (внутриигровая валюта), максимальная покупка была произведена на сумму в 486,615 лепестковю 
--Средняя стоимость покупки - около 525, медиана стоимости - 74.8 
--Медиана намного ниже средней стоимости, что означает, что многие покупки имеют небольшую цену, и небольшая часть пользователей совершает более крупные траты. 
--Также, максимальная покупка стоимостью 486,615 говорит что эта покупка не является “нормальным” поведением в границах игры и является крупной покупкой.
